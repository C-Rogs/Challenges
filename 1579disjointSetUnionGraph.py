...
Will investgate the disjointed set data structure more. '''
...
class Solution(object):
    def maxNumEdgesToRemove(self, n, edges):
        ...
        #Create disjointed sets to enable efficient finding of common edges 
        class UnionFind:
            def __init__(self, n):
        ...
        #If a type 3 edge connects two unconnected nodes then it is required. 
        for edge in edges:
            if edge[0] == 3:
